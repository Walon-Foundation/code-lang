...
fn first(args: Vec<Object>, info: CallInfo) -> Object {
    if args.len() != 1 {
        return Object::Error {
            message: "arrays.first expects 1 argument".to_string(),
            line: info.line,
            column: info.column,
        };
    }
    match &args[0] {
        ...
        _ => Object::Error {
            message: format!("arrays.first expects ARRAY, got {}", args[0].type_name()),
            line: info.line,
            column: info.column,
        },
    }
...
fn last(args: Vec<Object>, info: CallInfo) -> Object {
    if args.len() != 1 {
        return Object::Error {
            message: "arrays.last expects 1 argument".to_string(),
            line: info.line,
            column: info.column,
        };
    }
    match &args[0] {
        ...
        _ => Object::Error {
            message: format!("arrays.last expects ARRAY, got {}", args[0].type_name()),
            line: info.line,
            column: info.column,
        },
    }
...
fn rest(args: Vec<Object>, info: CallInfo) -> Object {
    if args.len() != 1 {
        return Object::Error {
            message: "arrays.rest expects 1 argument".to_string(),
            line: info.line,
            column: info.column,
        };
    }
    match &args[0] {
        ...
        _ => Object::Error {
            message: format!("arrays.rest expects ARRAY, got {}", args[0].type_name()),
            line: info.line,
            column: info.column,
        },
    }
...
fn push(args: Vec<Object>, info: CallInfo) -> Object {
    if args.len() != 2 {
        return Object::Error {
            message: "arrays.push expects 2 arguments".to_string(),
            line: info.line,
            column: info.column,
        };
    }
    match &args[0] {
        ...
        _ => Object::Error {
            message: format!(
                "arrays.push expects ARRAY as first argument, got {}",
                args[0].type_name()
            ),
            line: info.line,
            column: info.column,
...
fn len(args: Vec<Object>, info: CallInfo) -> Object {
    if args.len() != 1 {
        return Object::Error {
            message: "arrays.len expects 1 argument".to_string(),
            line: info.line,
            column: info.column,
        };
    }
...
fn pop(args: Vec<Object>, info: CallInfo) -> Object {
    if args.len() != 1 {
        return Object::Error {
            message: "arrays.pop expects 1 argument".to_string(),
            line: info.line,
            column: info.column,
        };
    }
    match &args[0] {
        ...
        _ => Object::Error {
            message: format!("arrays.pop expects ARRAY, got {}", args[0].type_name()),
            line: info.line,
            column: info.column,
        },
    }
...
fn prepend(args: Vec<Object>, info: CallInfo) -> Object {
    if args.len() != 2 {
        return Object::Error {
            message: "arrays.prepend expects 2 arguments".to_string(),
            line: info.line,
            column: info.column,
        };
    }
    match &args[0] {
        ...
        _ => Object::Error {
            message: format!(
                "arrays.prepend expects ARRAY as first argument, got {}",
                args[0].type_name()
            ),
            line: info.line,
            column: info.column,
...
fn reverse(args: Vec<Object>, info: CallInfo) -> Object {
    if args.len() != 1 {
        return Object::Error {
            message: "arrays.reverse expects 1 argument".to_string(),
            line: info.line,
            column: info.column,
        };
    }
    match &args[0] {
        ...
        _ => Object::Error {
            message: format!("arrays.reverse expects ARRAY, got {}", args[0].type_name()),
            line: info.line,
            column: info.column,
        },
    }
...
fn contains(args: Vec<Object>, info: CallInfo) -> Object {
    if args.len() != 2 {
        return Object::Error {
            message: "arrays.contains expects 2 arguments".to_string(),
            line: info.line,
            column: info.column,
        };
    }
    match &args[0] {
        ...
        _ => Object::Error {
            message: format!(
                "arrays.contains expects ARRAY as first argument, got {}",
                args[0].type_name()
            ),
            line: info.line,
            column: info.column,
...
fn index_of(args: Vec<Object>, info: CallInfo) -> Object {
    if args.len() != 2 {
        return Object::Error {
            message: "arrays.index_of expects 2 arguments".to_string(),
            line: info.line,
            column: info.column,
        };
    }
    match &args[0] {
        ...
        _ => Object::Error {
            message: format!(
                "arrays.index_of expects ARRAY as first argument, got {}",
                args[0].type_name()
            ),
            line: info.line,
            column: info.column,
...
fn slice(args: Vec<Object>, info: CallInfo) -> Object {
    if args.len() != 3 {
        return Object::Error {
            message: "arrays.slice expects 3 arguments".to_string(),
            line: info.line,
            column: info.column,
        };
    }
    let elems = match &args[0] {
        ...
        _ => {
            return Object::Error {
                message: format!(
                    "arrays.slice expects ARRAY as first argument, got {}",
                    args[0].type_name()
                ),
                line: info.line,
                column: info.column,
    ...
    let start = match &args[1] {
        ...
        _ => {
            return Object::Error {
                message: format!(
                    "arrays.slice: start must be INTEGER, got {}",
                    args[1].type_name()
                ),
                line: info.line,
                column: info.column,
    ...
    let end = match &args[2] {
        ...
        _ => {
            return Object::Error {
                message: format!(
                    "arrays.slice: end must be INTEGER, got {}",
                    args[2].type_name()
                ),
                line: info.line,
                column: info.column,
...
fn join(args: Vec<Object>, info: CallInfo) -> Object {
    if args.len() != 2 {
        return Object::Error {
            message: "arrays.join expects 2 arguments".to_string(),
            line: info.line,
            column: info.column,
        };
    }
    let elems = match &args[0] {
        ...
        _ => {
            return Object::Error {
                message: format!(
                    "arrays.join expects ARRAY as first argument, got {}",
                    args[0].type_name()
                ),
                line: info.line,
                column: info.column,
    ...
    let sep = match &args[1] {
        ...
        _ => {
            return Object::Error {
                message: format!(
                    "arrays.join: separator must be STRING, got {}",
                    args[1].type_name()
                ),
                line: info.line,
                column: info.column,
...
fn concat(args: Vec<Object>, info: CallInfo) -> Object {
    if args.len() != 2 {
        return Object::Error {
            message: "arrays.concat expects 2 arguments".to_string(),
            line: info.line,
            column: info.column,
        };
    }
    let a = match &args[0] {
        ...
        _ => {
            return Object::Error {
                message: format!(
                    "arrays.concat expects ARRAY as first argument, got {}",
                    args[0].type_name()
                ),
                line: info.line,
                column: info.column,
    ...
    let b = match &args[1] {
        ...
        _ => {
            return Object::Error {
                message: format!(
                    "arrays.concat expects ARRAY as second argument, got {}",
                    args[1].type_name()
                ),
                line: info.line,
                column: info.column,
...
fn sum(args: Vec<Object>, info: CallInfo) -> Object {
    if args.len() != 1 {
        return Object::Error {
            message: "arrays.sum expects 1 argument".to_string(),
            line: info.line,
            column: info.column,
        };
    }
    let elems = match &args[0] {
        ...
        _ => {
            return Object::Error {
                message: format!("arrays.sum expects ARRAY, got {}", args[0].type_name()),
                line: info.line,
                column: info.column,
            };
        }
    ...
    for e in &elems {
        match e {
            ...
            _ => {
                return Object::Error {
                    message: format!(
                        "arrays.sum: expected numeric elements, got {}",
                        e.type_name()
                    ),
                    line: info.line,
                    column: info.column,
...
fn min(args: Vec<Object>, info: CallInfo) -> Object {
    if args.len() != 1 {
        return Object::Error {
            message: "arrays.min expects 1 argument".to_string(),
            line: info.line,
            column: info.column,
        };
    }
    let elems = match &args[0] {
        ...
        _ => {
            return Object::Error {
                message: format!("arrays.min expects ARRAY, got {}", args[0].type_name()),
                line: info.line,
                column: info.column,
            };
        }
    ...
    for e in &elems[1..] {
        let less = match (&result, e) {
            ...
            _ => {
                return Object::Error {
                    message: format!(
                        "arrays.min: expected numeric elements, got {}",
                        e.type_name()
                    ),
                    line: info.line,
                    column: info.column,
...
fn max(args: Vec<Object>, info: CallInfo) -> Object {
    if args.len() != 1 {
        return Object::Error {
            message: "arrays.max expects 1 argument".to_string(),
            line: info.line,
            column: info.column,
        };
    }
    let elems = match &args[0] {
        ...
        _ => {
            return Object::Error {
                message: format!("arrays.max expects ARRAY, got {}", args[0].type_name()),
                line: info.line,
                column: info.column,
            };
        }
    ...
    for e in &elems[1..] {
        let greater = match (&result, e) {
            ...
            _ => {
                return Object::Error {
                    message: format!(
                        "arrays.max: expected numeric elements, got {}",
                        e.type_name()
                    ),
                    line: info.line,
                    column: info.column,
...
fn flatten(args: Vec<Object>, info: CallInfo) -> Object {
    if args.len() != 1 {
        return Object::Error {
            message: "arrays.flatten expects 1 argument".to_string(),
            line: info.line,
            column: info.column,
        };
    }
    match &args[0] {
        ...
        _ => Object::Error {
            message: format!("arrays.flatten expects ARRAY, got {}", args[0].type_name()),
            line: info.line,
            column: info.column,
        },
    }
...
fn sort(args: Vec<Object>, info: CallInfo) -> Object {
    if args.len() != 1 {
        return Object::Error {
            message: "arrays.sort expects 1 argument".to_string(),
            line: info.line,
            column: info.column,
        };
    }
    let elems = match &args[0] {
        ...
        _ => {
            return Object::Error {
                message: format!("arrays.sort expects ARRAY, got {}", args[0].type_name()),
                line: info.line,
                column: info.column,
            };
        }
    ...
    new.sort_by(|a, b| {
        ...
        match (a, b) {
            ...
            (Object::Integer(x), Object::Float(y)) => (*x as f64)
                .partial_cmp(y)
                .unwrap_or(std::cmp::Ordering::Equal),
            (Object::Float(x), Object::Integer(y)) => x
                .partial_cmp(&(*y as f64))
                .unwrap_or(std::cmp::Ordering::Equal),
            (Object::StringType(x), Object::StringType(y)) => x.cmp(y),
            _ => {
                err = Some(Object::Error {
                    message: "arrays.sort: cannot sort mixed or unsupported types".to_string(),
                    line: info.line,
                    column: info.column,
                });
...
fn unique(args: Vec<Object>, info: CallInfo) -> Object {
    if args.len() != 1 {
        return Object::Error {
            message: "arrays.unique expects 1 argument".to_string(),
            line: info.line,
            column: info.column,
        };
    }
    match &args[0] {
        ...
        _ => Object::Error {
            message: format!("arrays.unique expects ARRAY, got {}", args[0].type_name()),
            line: info.line,
            column: info.column,
        },
    }
...
fn zip(args: Vec<Object>, info: CallInfo) -> Object {
    if args.len() != 2 {
        return Object::Error {
            message: "arrays.zip expects 2 arguments".to_string(),
            line: info.line,
            column: info.column,
        };
    }
    let a = match &args[0] {
        ...
        _ => {
            return Object::Error {
                message: format!(
                    "arrays.zip expects ARRAY as first argument, got {}",
                    args[0].type_name()
                ),
                line: info.line,
                column: info.column,
    ...
    let b = match &args[1] {
        ...
        _ => {
            return Object::Error {
                message: format!(
                    "arrays.zip expects ARRAY as second argument, got {}",
                    args[1].type_name()
                ),
                line: info.line,
                column: info.column,
...
fn array_map(args: Vec<Object>, info: CallInfo, eval: &mut dyn Evaluable) -> Object {
    if args.len() != 2 {
        return Object::Error {
            message: "arrays.map expects 2 arguments".to_string(),
            line: info.line,
            column: info.column,
        };
    }
    let elems = match &args[0] {
        ...
        _ => {
            return Object::Error {
                message: format!(
                    "arrays.map expects ARRAY as first argument, got {}",
                    args[0].type_name()
                ),
                line: info.line,
                column: info.column,
...
fn array_filter(args: Vec<Object>, info: CallInfo, eval: &mut dyn Evaluable) -> Object {
    if args.len() != 2 {
        return Object::Error {
            message: "arrays.filter expects 2 arguments".to_string(),
            line: info.line,
            column: info.column,
        };
    }
    let elems = match &args[0] {
        ...
        _ => {
            return Object::Error {
                message: format!(
                    "arrays.filter expects ARRAY as first argument, got {}",
                    args[0].type_name()
                ),
                line: info.line,
                column: info.column,
...
fn array_reduce(args: Vec<Object>, info: CallInfo, eval: &mut dyn Evaluable) -> Object {
    if args.len() != 3 {
        return Object::Error {
            message: "arrays.reduce expects 3 arguments".to_string(),
            line: info.line,
            column: info.column,
        };
    }
    let elems = match &args[0] {
        ...
        _ => {
            return Object::Error {
                message: format!(
                    "arrays.reduce expects ARRAY as first argument, got {}",
                    args[0].type_name()
                ),
                line: info.line,
                column: info.column,
...
fn array_find(args: Vec<Object>, info: CallInfo, eval: &mut dyn Evaluable) -> Object {
    if args.len() != 2 {
        return Object::Error {
            message: "arrays.find expects 2 arguments".to_string(),
            line: info.line,
            column: info.column,
        };
    }
    let elems = match &args[0] {
        ...
        _ => {
            return Object::Error {
                message: format!(
                    "arrays.find expects ARRAY as first argument, got {}",
                    args[0].type_name()
                ),
                line: info.line,
                column: info.column,
...
fn array_any(args: Vec<Object>, info: CallInfo, eval: &mut dyn Evaluable) -> Object {
    if args.len() != 2 {
        return Object::Error {
            message: "arrays.any expects 2 arguments".to_string(),
            line: info.line,
            column: info.column,
        };
    }
    let elems = match &args[0] {
        ...
        _ => {
            return Object::Error {
                message: format!(
                    "arrays.any expects ARRAY as first argument, got {}",
                    args[0].type_name()
                ),
                line: info.line,
                column: info.column,
...
fn array_all(args: Vec<Object>, info: CallInfo, eval: &mut dyn Evaluable) -> Object {
    if args.len() != 2 {
        return Object::Error {
            message: "arrays.all expects 2 arguments".to_string(),
            line: info.line,
            column: info.column,
        };
    }
    let elems = match &args[0] {
        ...
        _ => {
            return Object::Error {
                message: format!(
                    "arrays.all expects ARRAY as first argument, got {}",
                    args[0].type_name()
                ),
                line: info.line,
                column: info.column,
...
pub fn module() -> Object {
    ...
    members.insert(
        "filter".to_string(),
        Object::BuiltinHigherOrder(array_filter),
    );
    members.insert(
        "reduce".to_string(),
        Object::BuiltinHigherOrder(array_reduce),
    );
