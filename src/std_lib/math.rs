...
fn sqrt(args: Vec<Object>, info: CallInfo) -> Object {
    if args.len() != 1 {
        return Object::Error {
            message: "math.sqrt takes 1 argument".to_string(),
            line: info.line,
            column: info.column,
        };
    }
    match to_f64(&args[0]) {
        ...
        None => Object::Error {
            message: format!("math.sqrt expects a number, got {}", args[0].type_name()),
            line: info.line,
            column: info.column,
        },
    }
...
fn floor(args: Vec<Object>, info: CallInfo) -> Object {
    if args.len() != 1 {
        return Object::Error {
            message: "math.floor takes 1 argument".to_string(),
            line: info.line,
            column: info.column,
        };
    }
    match to_f64(&args[0]) {
        ...
        None => Object::Error {
            message: format!("math.floor expects a number, got {}", args[0].type_name()),
            line: info.line,
            column: info.column,
        },
    }
...
fn ceil(args: Vec<Object>, info: CallInfo) -> Object {
    if args.len() != 1 {
        return Object::Error {
            message: "math.ceil takes 1 argument".to_string(),
            line: info.line,
            column: info.column,
        };
    }
    match to_f64(&args[0]) {
        ...
        None => Object::Error {
            message: format!("math.ceil expects a number, got {}", args[0].type_name()),
            line: info.line,
            column: info.column,
        },
    }
...
fn round(args: Vec<Object>, info: CallInfo) -> Object {
    if args.len() != 1 {
        return Object::Error {
            message: "math.round takes 1 argument".to_string(),
            line: info.line,
            column: info.column,
        };
    }
    match to_f64(&args[0]) {
        ...
        None => Object::Error {
            message: format!("math.round expects a number, got {}", args[0].type_name()),
            line: info.line,
            column: info.column,
        },
    }
...
fn trunc(args: Vec<Object>, info: CallInfo) -> Object {
    if args.len() != 1 {
        return Object::Error {
            message: "math.trunc takes 1 argument".to_string(),
            line: info.line,
            column: info.column,
        };
    }
    match to_f64(&args[0]) {
        ...
        None => Object::Error {
            message: format!("math.trunc expects a number, got {}", args[0].type_name()),
            line: info.line,
            column: info.column,
        },
    }
...
fn abs(args: Vec<Object>, info: CallInfo) -> Object {
    if args.len() != 1 {
        return Object::Error {
            message: "math.abs takes 1 argument".to_string(),
            line: info.line,
            column: info.column,
        };
    }
    match &args[0] {
        ...
        _ => Object::Error {
            message: format!("math.abs expects a number, got {}", args[0].type_name()),
            line: info.line,
            column: info.column,
        },
    }
...
fn pow(args: Vec<Object>, info: CallInfo) -> Object {
    if args.len() != 2 {
        return Object::Error {
            message: "math.pow takes 2 arguments".to_string(),
            line: info.line,
            column: info.column,
        };
    }
    let base = match to_f64(&args[0]) {
        ...
        None => {
            return Object::Error {
                message: format!("math.pow expects numbers, got {}", args[0].type_name()),
                line: info.line,
                column: info.column,
            };
        }
    ...
    let exp = match to_f64(&args[1]) {
        ...
        None => {
            return Object::Error {
                message: format!("math.pow expects numbers, got {}", args[1].type_name()),
                line: info.line,
                column: info.column,
            };
        }
...
fn log(args: Vec<Object>, info: CallInfo) -> Object {
    if args.len() != 1 {
        return Object::Error {
            message: "math.log takes 1 argument".to_string(),
            line: info.line,
            column: info.column,
        };
    }
    match to_f64(&args[0]) {
        ...
        None => Object::Error {
            message: format!("math.log expects a number, got {}", args[0].type_name()),
            line: info.line,
            column: info.column,
        },
    }
...
fn log10(args: Vec<Object>, info: CallInfo) -> Object {
    if args.len() != 1 {
        return Object::Error {
            message: "math.log10 takes 1 argument".to_string(),
            line: info.line,
            column: info.column,
        };
    }
    match to_f64(&args[0]) {
        ...
        None => Object::Error {
            message: format!("math.log10 expects a number, got {}", args[0].type_name()),
            line: info.line,
            column: info.column,
        },
    }
...
fn exp(args: Vec<Object>, info: CallInfo) -> Object {
    if args.len() != 1 {
        return Object::Error {
            message: "math.exp takes 1 argument".to_string(),
            line: info.line,
            column: info.column,
        };
    }
    match to_f64(&args[0]) {
        ...
        None => Object::Error {
            message: format!("math.exp expects a number, got {}", args[0].type_name()),
            line: info.line,
            column: info.column,
        },
    }
...
fn sin(args: Vec<Object>, info: CallInfo) -> Object {
    if args.len() != 1 {
        return Object::Error {
            message: "math.sin takes 1 argument".to_string(),
            line: info.line,
            column: info.column,
        };
    }
    match to_f64(&args[0]) {
        ...
        None => Object::Error {
            message: format!("math.sin expects a number, got {}", args[0].type_name()),
            line: info.line,
            column: info.column,
        },
    }
...
fn cos(args: Vec<Object>, info: CallInfo) -> Object {
    if args.len() != 1 {
        return Object::Error {
            message: "math.cos takes 1 argument".to_string(),
            line: info.line,
            column: info.column,
        };
    }
    match to_f64(&args[0]) {
        ...
        None => Object::Error {
            message: format!("math.cos expects a number, got {}", args[0].type_name()),
            line: info.line,
            column: info.column,
        },
    }
...
fn tan(args: Vec<Object>, info: CallInfo) -> Object {
    if args.len() != 1 {
        return Object::Error {
            message: "math.tan takes 1 argument".to_string(),
            line: info.line,
            column: info.column,
        };
    }
    match to_f64(&args[0]) {
        ...
        None => Object::Error {
            message: format!("math.tan expects a number, got {}", args[0].type_name()),
            line: info.line,
            column: info.column,
        },
    }
...
fn min(args: Vec<Object>, info: CallInfo) -> Object {
    if args.is_empty() {
        return Object::Error {
            message: "math.min takes at least 1 argument".to_string(),
            line: info.line,
            column: info.column,
        };
    }
    let mut result = match to_f64(&args[0]) {
        ...
        None => {
            return Object::Error {
                message: format!("math.min expects numbers, got {}", args[0].type_name()),
                line: info.line,
                column: info.column,
            };
        }
    ...
    for a in &args[1..] {
        match to_f64(a) {
            ...
            None => {
                return Object::Error {
                    message: format!("math.min expects numbers, got {}", a.type_name()),
                    line: info.line,
                    column: info.column,
                };
            }
...
fn max(args: Vec<Object>, info: CallInfo) -> Object {
    if args.is_empty() {
        return Object::Error {
            message: "math.max takes at least 1 argument".to_string(),
            line: info.line,
            column: info.column,
        };
    }
    let mut result = match to_f64(&args[0]) {
        ...
        None => {
            return Object::Error {
                message: format!("math.max expects numbers, got {}", args[0].type_name()),
                line: info.line,
                column: info.column,
            };
        }
    ...
    for a in &args[1..] {
        match to_f64(a) {
            ...
            None => {
                return Object::Error {
                    message: format!("math.max expects numbers, got {}", a.type_name()),
                    line: info.line,
                    column: info.column,
                };
            }
...
fn clamp(args: Vec<Object>, info: CallInfo) -> Object {
    if args.len() != 3 {
        return Object::Error {
            message: "math.clamp takes 3 arguments: value, min, max".to_string(),
            line: info.line,
            column: info.column,
        };
    }
    let v = match to_f64(&args[0]) {
        ...
        None => {
            return Object::Error {
                message: format!("math.clamp expects numbers, got {}", args[0].type_name()),
                line: info.line,
                column: info.column,
            };
        }
    ...
    let lo = match to_f64(&args[1]) {
        ...
        None => {
            return Object::Error {
                message: format!("math.clamp expects numbers, got {}", args[1].type_name()),
                line: info.line,
                column: info.column,
            };
        }
    ...
    let hi = match to_f64(&args[2]) {
        ...
        None => {
            return Object::Error {
                message: format!("math.clamp expects numbers, got {}", args[2].type_name()),
                line: info.line,
                column: info.column,
            };
        }
...
fn log2(args: Vec<Object>, info: CallInfo) -> Object {
    if args.len() != 1 {
        return Object::Error {
            message: "math.log2 takes 1 argument".to_string(),
            line: info.line,
            column: info.column,
        };
    }
    match to_f64(&args[0]) {
        ...
        None => Object::Error {
            message: format!("math.log2 expects a number, got {}", args[0].type_name()),
            line: info.line,
            column: info.column,
        },
    }
...
fn sign(args: Vec<Object>, info: CallInfo) -> Object {
    if args.len() != 1 {
        return Object::Error {
            message: "math.sign takes 1 argument".to_string(),
            line: info.line,
            column: info.column,
        };
    }
    match &args[0] {
        ...
        _ => Object::Error {
            message: format!("math.sign expects a number, got {}", args[0].type_name()),
            line: info.line,
            column: info.column,
        },
    }
...
fn gcd(args: Vec<Object>, info: CallInfo) -> Object {
    if args.len() != 2 {
        return Object::Error {
            message: "math.gcd takes 2 arguments".to_string(),
            line: info.line,
            column: info.column,
        };
    }
    let a = match &args[0] {
        ...
        _ => {
            return Object::Error {
                message: format!(
                    "math.gcd expects INTEGER arguments, got {}",
                    args[0].type_name()
                ),
                line: info.line,
                column: info.column,
...
fn lcm(args: Vec<Object>, info: CallInfo) -> Object {
    if args.len() != 2 {
        return Object::Error {
            message: "math.lcm takes 2 arguments".to_string(),
            line: info.line,
            column: info.column,
        };
    }
    let a = match &args[0] {
        ...
        _ => {
            return Object::Error {
                message: format!(
                    "math.lcm expects INTEGER arguments, got {}",
                    args[0].type_name()
                ),
                line: info.line,
                column: info.column,
