...
fn join(args: Vec<Object>, info: CallInfo) -> Object {
    if args.len() < 2 {
        return Object::Error {
            message: "path.join takes at least 2 arguments".to_string(),
            line: info.line,
            column: info.column,
        };
    }
    ...
    for a in &args {
        match a {
            ...
            _ => {
                return Object::Error {
                    message: format!("path.join expects STRING arguments, got {}", a.type_name()),
                    line: info.line,
                    column: info.column,
                };
            }
...
fn basename(args: Vec<Object>, info: CallInfo) -> Object {
    if args.len() != 1 {
        return Object::Error {
            message: "path.basename takes 1 argument".to_string(),
            line: info.line,
            column: info.column,
        };
    }
    match &args[0] {
        ...
        _ => Object::Error {
            message: format!("path.basename expects STRING, got {}", args[0].type_name()),
            line: info.line,
            column: info.column,
        },
    }
...
fn dirname(args: Vec<Object>, info: CallInfo) -> Object {
    if args.len() != 1 {
        return Object::Error {
            message: "path.dirname takes 1 argument".to_string(),
            line: info.line,
            column: info.column,
        };
    }
    match &args[0] {
        ...
        _ => Object::Error {
            message: format!("path.dirname expects STRING, got {}", args[0].type_name()),
            line: info.line,
            column: info.column,
        },
    }
...
fn extension(args: Vec<Object>, info: CallInfo) -> Object {
    if args.len() != 1 {
        return Object::Error {
            message: "path.extension takes 1 argument".to_string(),
            line: info.line,
            column: info.column,
        };
    }
    match &args[0] {
        ...
        _ => Object::Error {
            message: format!("path.extension expects STRING, got {}", args[0].type_name()),
            line: info.line,
            column: info.column,
        },
    }
...
fn stem(args: Vec<Object>, info: CallInfo) -> Object {
    if args.len() != 1 {
        return Object::Error {
            message: "path.stem takes 1 argument".to_string(),
            line: info.line,
            column: info.column,
        };
    }
    match &args[0] {
        ...
        _ => Object::Error {
            message: format!("path.stem expects STRING, got {}", args[0].type_name()),
            line: info.line,
            column: info.column,
        },
    }
...
fn absolute(args: Vec<Object>, info: CallInfo) -> Object {
    if args.len() != 1 {
        return Object::Error {
            message: "path.absolute takes 1 argument".to_string(),
            line: info.line,
            column: info.column,
        };
    }
    match &args[0] {
        Object::StringType(s) => match std::fs::canonicalize(s) {
            ...
            Err(e) => Object::Error {
                message: format!("path.absolute: {}", e),
                line: info.line,
                column: info.column,
            },
        },
        _ => Object::Error {
            message: format!("path.absolute expects STRING, got {}", args[0].type_name()),
            line: info.line,
            column: info.column,
        },
    }
...
fn is_absolute(args: Vec<Object>, info: CallInfo) -> Object {
    if args.len() != 1 {
        return Object::Error {
            message: "path.is_absolute takes 1 argument".to_string(),
            line: info.line,
            column: info.column,
        };
    }
    match &args[0] {
        ...
        _ => Object::Error {
            message: format!(
                "path.is_absolute expects STRING, got {}",
                args[0].type_name()
            ),
            line: info.line,
            column: info.column,
