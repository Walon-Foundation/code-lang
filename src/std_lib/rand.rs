...
fn int(args: Vec<Object>, info: CallInfo) -> Object {
    if args.len() != 2 {
        return Object::Error {
            message: "rand.int takes 2 arguments: min and max (inclusive)".to_string(),
            line: info.line,
            column: info.column,
        };
    }
    let min = match &args[0] {
        ...
        _ => {
            return Object::Error {
                message: format!(
                    "rand.int expects INTEGER as first argument, got {}",
                    args[0].type_name()
                ),
                line: info.line,
                column: info.column,
    ...
    let max = match &args[1] {
        ...
        _ => {
            return Object::Error {
                message: format!(
                    "rand.int expects INTEGER as second argument, got {}",
                    args[1].type_name()
                ),
                line: info.line,
                column: info.column,
    ...
    if min > max {
        return Object::Error {
            message: format!("rand.int: min ({}) must be <= max ({})", min, max),
            line: info.line,
            column: info.column,
        };
    }
...
fn float(args: Vec<Object>, info: CallInfo) -> Object {
    if !args.is_empty() {
        return Object::Error {
            message: "rand.float takes no arguments".to_string(),
            line: info.line,
            column: info.column,
        };
    }
...
fn choice(args: Vec<Object>, info: CallInfo) -> Object {
    if args.len() != 1 {
        return Object::Error {
            message: "rand.choice takes 1 argument".to_string(),
            line: info.line,
            column: info.column,
        };
    }
    match &args[0] {
        ...
        _ => Object::Error {
            message: format!("rand.choice expects ARRAY, got {}", args[0].type_name()),
            line: info.line,
            column: info.column,
        },
    }
...
fn shuffle(args: Vec<Object>, info: CallInfo) -> Object {
    if args.len() != 1 {
        return Object::Error {
            message: "rand.shuffle takes 1 argument".to_string(),
            line: info.line,
            column: info.column,
        };
    }
    match &args[0] {
        ...
        _ => Object::Error {
            message: format!("rand.shuffle expects ARRAY, got {}", args[0].type_name()),
            line: info.line,
            column: info.column,
        },
    }
