...
fn to_upper(args: Vec<Object>, info: CallInfo) -> Object {
    if args.len() != 1 {
        return Object::Error {
            message: "strings.to_upper takes 1 argument".to_string(),
            line: info.line,
            column: info.column,
        };
    }
    match &args[0] {
        ...
        _ => Object::Error {
            message: format!(
                "strings.to_upper expects STRING, got {}",
                args[0].type_name()
            ),
            line: info.line,
            column: info.column,
...
fn to_lower(args: Vec<Object>, info: CallInfo) -> Object {
    if args.len() != 1 {
        return Object::Error {
            message: "strings.to_lower takes 1 argument".to_string(),
            line: info.line,
            column: info.column,
        };
    }
    match &args[0] {
        ...
        _ => Object::Error {
            message: format!(
                "strings.to_lower expects STRING, got {}",
                args[0].type_name()
            ),
            line: info.line,
            column: info.column,
...
fn split(args: Vec<Object>, info: CallInfo) -> Object {
    if args.len() != 2 {
        return Object::Error {
            message: "strings.split takes 2 arguments".to_string(),
            line: info.line,
            column: info.column,
        };
    }
    let s = match &args[0] {
        ...
        _ => {
            return Object::Error {
                message: format!(
                    "strings.split expects STRING as first argument, got {}",
                    args[0].type_name()
                ),
                line: info.line,
                column: info.column,
    ...
    let sep = match &args[1] {
        ...
        _ => {
            return Object::Error {
                message: format!(
                    "strings.split expects STRING as second argument, got {}",
                    args[1].type_name()
                ),
                line: info.line,
                column: info.column,
    ...
    let parts = s
        .split(sep.as_str())
        .map(|p| Object::StringType(p.to_string()))
        .collect();
    Object::Array(parts)
}
...
fn join(args: Vec<Object>, info: CallInfo) -> Object {
    if args.len() != 2 {
        return Object::Error {
            message: "strings.join takes 2 arguments".to_string(),
            line: info.line,
            column: info.column,
        };
    }
    let arr = match &args[0] {
        ...
        _ => {
            return Object::Error {
                message: format!(
                    "strings.join expects ARRAY as first argument, got {}",
                    args[0].type_name()
                ),
                line: info.line,
                column: info.column,
    ...
    let sep = match &args[1] {
        ...
        _ => {
            return Object::Error {
                message: format!(
                    "strings.join expects STRING as second argument, got {}",
                    args[1].type_name()
                ),
                line: info.line,
                column: info.column,
...
fn contains(args: Vec<Object>, info: CallInfo) -> Object {
    if args.len() != 2 {
        return Object::Error {
            message: "strings.contains takes 2 arguments".to_string(),
            line: info.line,
            column: info.column,
        };
    }
    let s = match &args[0] {
        ...
        _ => {
            return Object::Error {
                message: format!(
                    "strings.contains expects STRING as first argument, got {}",
                    args[0].type_name()
                ),
                line: info.line,
                column: info.column,
    ...
    let substr = match &args[1] {
        ...
        _ => {
            return Object::Error {
                message: format!(
                    "strings.contains expects STRING as second argument, got {}",
                    args[1].type_name()
                ),
                line: info.line,
                column: info.column,
...
fn replace(args: Vec<Object>, info: CallInfo) -> Object {
    if args.len() != 3 {
        return Object::Error {
            message: "strings.replace takes 3 arguments: string, old, new".to_string(),
            line: info.line,
            column: info.column,
        };
    }
    let s = match &args[0] {
        ...
        _ => {
            return Object::Error {
                message: format!(
                    "strings.replace expects STRING as first argument, got {}",
                    args[0].type_name()
                ),
                line: info.line,
                column: info.column,
    ...
    let old = match &args[1] {
        ...
        _ => {
            return Object::Error {
                message: format!(
                    "strings.replace expects STRING as second argument, got {}",
                    args[1].type_name()
                ),
                line: info.line,
                column: info.column,
    ...
    let new = match &args[2] {
        ...
        _ => {
            return Object::Error {
                message: format!(
                    "strings.replace expects STRING as third argument, got {}",
                    args[2].type_name()
                ),
                line: info.line,
                column: info.column,
...
fn trim(args: Vec<Object>, info: CallInfo) -> Object {
    if args.len() != 1 {
        return Object::Error {
            message: "strings.trim takes 1 argument".to_string(),
            line: info.line,
            column: info.column,
        };
    }
    match &args[0] {
        ...
        _ => Object::Error {
            message: format!("strings.trim expects STRING, got {}", args[0].type_name()),
            line: info.line,
            column: info.column,
        },
    }
...
fn trim_left(args: Vec<Object>, info: CallInfo) -> Object {
    if args.len() != 1 {
        return Object::Error {
            message: "strings.trim_left takes 1 argument".to_string(),
            line: info.line,
            column: info.column,
        };
    }
    match &args[0] {
        ...
        _ => Object::Error {
            message: format!(
                "strings.trim_left expects STRING, got {}",
                args[0].type_name()
            ),
            line: info.line,
            column: info.column,
...
fn trim_right(args: Vec<Object>, info: CallInfo) -> Object {
    if args.len() != 1 {
        return Object::Error {
            message: "strings.trim_right takes 1 argument".to_string(),
            line: info.line,
            column: info.column,
        };
    }
    match &args[0] {
        ...
        _ => Object::Error {
            message: format!(
                "strings.trim_right expects STRING, got {}",
                args[0].type_name()
            ),
            line: info.line,
            column: info.column,
...
fn starts_with(args: Vec<Object>, info: CallInfo) -> Object {
    if args.len() != 2 {
        return Object::Error {
            message: "strings.starts_with takes 2 arguments".to_string(),
            line: info.line,
            column: info.column,
        };
    }
    let s = match &args[0] {
        ...
        _ => {
            return Object::Error {
                message: format!(
                    "strings.starts_with expects STRING as first argument, got {}",
                    args[0].type_name()
                ),
                line: info.line,
                column: info.column,
    ...
    let prefix = match &args[1] {
        ...
        _ => {
            return Object::Error {
                message: format!(
                    "strings.starts_with expects STRING as second argument, got {}",
                    args[1].type_name()
                ),
                line: info.line,
                column: info.column,
...
fn ends_with(args: Vec<Object>, info: CallInfo) -> Object {
    if args.len() != 2 {
        return Object::Error {
            message: "strings.ends_with takes 2 arguments".to_string(),
            line: info.line,
            column: info.column,
        };
    }
    let s = match &args[0] {
        ...
        _ => {
            return Object::Error {
                message: format!(
                    "strings.ends_with expects STRING as first argument, got {}",
                    args[0].type_name()
                ),
                line: info.line,
                column: info.column,
    ...
    let suffix = match &args[1] {
        ...
        _ => {
            return Object::Error {
                message: format!(
                    "strings.ends_with expects STRING as second argument, got {}",
                    args[1].type_name()
                ),
                line: info.line,
                column: info.column,
...
fn index(args: Vec<Object>, info: CallInfo) -> Object {
    if args.len() != 2 {
        return Object::Error {
            message: "strings.index takes 2 arguments".to_string(),
            line: info.line,
            column: info.column,
        };
    }
    let s = match &args[0] {
        ...
        _ => {
            return Object::Error {
                message: format!(
                    "strings.index expects STRING as first argument, got {}",
                    args[0].type_name()
                ),
                line: info.line,
                column: info.column,
    ...
    let substr = match &args[1] {
        ...
        _ => {
            return Object::Error {
                message: format!(
                    "strings.index expects STRING as second argument, got {}",
                    args[1].type_name()
                ),
                line: info.line,
                column: info.column,
...
fn count(args: Vec<Object>, info: CallInfo) -> Object {
    if args.len() != 2 {
        return Object::Error {
            message: "strings.count takes 2 arguments".to_string(),
            line: info.line,
            column: info.column,
        };
    }
    let s = match &args[0] {
        ...
        _ => {
            return Object::Error {
                message: format!(
                    "strings.count expects STRING as first argument, got {}",
                    args[0].type_name()
                ),
                line: info.line,
                column: info.column,
    ...
    let substr = match &args[1] {
        ...
        _ => {
            return Object::Error {
                message: format!(
                    "strings.count expects STRING as second argument, got {}",
                    args[1].type_name()
                ),
                line: info.line,
                column: info.column,
...
fn repeat(args: Vec<Object>, info: CallInfo) -> Object {
    if args.len() != 2 {
        return Object::Error {
            message: "strings.repeat takes 2 arguments: string and count".to_string(),
            line: info.line,
            column: info.column,
        };
    }
    let s = match &args[0] {
        ...
        _ => {
            return Object::Error {
                message: format!(
                    "strings.repeat expects STRING as first argument, got {}",
                    args[0].type_name()
                ),
                line: info.line,
                column: info.column,
    ...
    let n = match &args[1] {
        ...
        _ => {
            return Object::Error {
                message: format!(
                    "strings.repeat expects INTEGER as second argument, got {}",
                    args[1].type_name()
                ),
                line: info.line,
                column: info.column,
    ...
    if n < 0 {
        return Object::Error {
            message: "strings.repeat: count must be non-negative".to_string(),
            line: info.line,
            column: info.column,
        };
    }
...
fn reverse(args: Vec<Object>, info: CallInfo) -> Object {
    if args.len() != 1 {
        return Object::Error {
            message: "strings.reverse takes 1 argument".to_string(),
            line: info.line,
            column: info.column,
        };
    }
    match &args[0] {
        ...
        _ => Object::Error {
            message: format!(
                "strings.reverse expects STRING, got {}",
                args[0].type_name()
            ),
            line: info.line,
            column: info.column,
...
fn to_chars(args: Vec<Object>, info: CallInfo) -> Object {
    if args.len() != 1 {
        return Object::Error {
            message: "strings.to_chars takes 1 argument".to_string(),
            line: info.line,
            column: info.column,
        };
    }
    match &args[0] {
        ...
        _ => Object::Error {
            message: format!(
                "strings.to_chars expects STRING, got {}",
                args[0].type_name()
            ),
            line: info.line,
            column: info.column,
...
fn from_chars(args: Vec<Object>, info: CallInfo) -> Object {
    if args.len() != 1 {
        return Object::Error {
            message: "strings.from_chars takes 1 argument".to_string(),
            line: info.line,
            column: info.column,
        };
    }
    match &args[0] {
            ...
            for e in elems {
                match e {
                    ...
                    _ => {
                        return Object::Error {
                            message: format!(
                                "strings.from_chars: expected CHAR elements, got {}",
                                e.type_name()
                            ),
                            line: info.line,
                            column: info.column,
        ...
        _ => Object::Error {
            message: format!(
                "strings.from_chars expects ARRAY, got {}",
                args[0].type_name()
            ),
            line: info.line,
            column: info.column,
...
fn parse_int(args: Vec<Object>, info: CallInfo) -> Object {
    if args.len() != 1 {
        return Object::Error {
            message: "strings.parse_int takes 1 argument".to_string(),
            line: info.line,
            column: info.column,
        };
    }
    match &args[0] {
        ...
        _ => Object::Error {
            message: format!(
                "strings.parse_int expects STRING, got {}",
                args[0].type_name()
            ),
            line: info.line,
            column: info.column,
...
fn parse_float(args: Vec<Object>, info: CallInfo) -> Object {
    if args.len() != 1 {
        return Object::Error {
            message: "strings.parse_float takes 1 argument".to_string(),
            line: info.line,
            column: info.column,
        };
    }
    match &args[0] {
        Object::StringType(s) => match s.trim().parse::<f64>() {
            Ok(n) => Object::Float(n),
            Err(_) => Object::Error {
                message: format!("strings.parse_float: cannot parse \"{}\" as float", s),
                line: info.line,
                column: info.column,
            },
        },
        _ => Object::Error {
            message: format!(
                "strings.parse_float expects STRING, got {}",
                args[0].type_name()
            ),
            line: info.line,
            column: info.column,
...
fn lines(args: Vec<Object>, info: CallInfo) -> Object {
    if args.len() != 1 {
        return Object::Error {
            message: "strings.lines takes 1 argument".to_string(),
            line: info.line,
            column: info.column,
        };
    }
    match &args[0] {
        Object::StringType(s) => {
            let parts: Vec<Object> = s
                .lines()
                .map(|l| Object::StringType(l.to_string()))
                .collect();
            Object::Array(parts)
        }
        _ => Object::Error {
            message: format!("strings.lines expects STRING, got {}", args[0].type_name()),
            line: info.line,
            column: info.column,
        },
    }
...
fn is_empty(args: Vec<Object>, info: CallInfo) -> Object {
    if args.len() != 1 {
        return Object::Error {
            message: "strings.is_empty takes 1 argument".to_string(),
            line: info.line,
            column: info.column,
        };
    }
    match &args[0] {
        ...
        _ => Object::Error {
            message: format!(
                "strings.is_empty expects STRING, got {}",
                args[0].type_name()
            ),
            line: info.line,
            column: info.column,
...
fn pad_left(args: Vec<Object>, info: CallInfo) -> Object {
    if args.len() != 3 {
        return Object::Error {
            message: "strings.pad_left takes 3 arguments".to_string(),
            line: info.line,
            column: info.column,
        };
    }
    let s = match &args[0] {
        ...
        _ => {
            return Object::Error {
                message: format!(
                    "strings.pad_left expects STRING as first argument, got {}",
                    args[0].type_name()
                ),
                line: info.line,
                column: info.column,
    ...
    let width = match &args[1] {
        ...
        _ => {
            return Object::Error {
                message: format!(
                    "strings.pad_left expects INTEGER as second argument, got {}",
                    args[1].type_name()
                ),
                line: info.line,
                column: info.column,
    ...
    let pad_char = match &args[2] {
        ...
        _ => {
            return Object::Error {
                message: format!(
                    "strings.pad_left expects STRING or CHAR as third argument, got {}",
                    args[2].type_name()
                ),
                line: info.line,
                column: info.column,
...
fn pad_right(args: Vec<Object>, info: CallInfo) -> Object {
    if args.len() != 3 {
        return Object::Error {
            message: "strings.pad_right takes 3 arguments".to_string(),
            line: info.line,
            column: info.column,
        };
    }
    let s = match &args[0] {
        ...
        _ => {
            return Object::Error {
                message: format!(
                    "strings.pad_right expects STRING as first argument, got {}",
                    args[0].type_name()
                ),
                line: info.line,
                column: info.column,
    ...
    let width = match &args[1] {
        ...
        _ => {
            return Object::Error {
                message: format!(
                    "strings.pad_right expects INTEGER as second argument, got {}",
                    args[1].type_name()
                ),
                line: info.line,
                column: info.column,
    ...
    let pad_char = match &args[2] {
        ...
        _ => {
            return Object::Error {
                message: format!(
                    "strings.pad_right expects STRING or CHAR as third argument, got {}",
                    args[2].type_name()
                ),
                line: info.line,
                column: info.column,
