...
fn now(args: Vec<Object>, info: CallInfo) -> Object {
    if !args.is_empty() {
        return Object::Error {
            message: "time.now takes no arguments".to_string(),
            line: info.line,
            column: info.column,
        };
    }
...
fn unix(args: Vec<Object>, info: CallInfo) -> Object {
    if !args.is_empty() {
        return Object::Error {
            message: "time.unix takes no arguments".to_string(),
            line: info.line,
            column: info.column,
        };
    }
...
fn sleep(args: Vec<Object>, info: CallInfo) -> Object {
    if args.len() != 1 {
        return Object::Error {
            message: "time.sleep takes 1 argument (ms)".to_string(),
            line: info.line,
            column: info.column,
        };
    }
    match &args[0] {
        ...
        _ => Object::Error {
            message: format!("time.sleep expects INTEGER, got {}", args[0].type_name()),
            line: info.line,
            column: info.column,
        },
    }
...
fn since(args: Vec<Object>, info: CallInfo) -> Object {
    if args.len() != 1 {
        return Object::Error {
            message: "time.since takes 1 argument (unix ms timestamp)".to_string(),
            line: info.line,
            column: info.column,
        };
    }
...
fn format(args: Vec<Object>, info: CallInfo) -> Object {
    if args.len() != 2 {
        return Object::Error {
            message: "time.format takes 2 arguments: unix_ms and layout".to_string(),
            line: info.line,
            column: info.column,
        };
    }
    let ms = match &args[0] {
        ...
        _ => {
            return Object::Error {
                message: format!(
                    "time.format: first argument must be INTEGER (unix ms), got {}",
                    args[0].type_name()
                ),
                line: info.line,
                column: info.column,
    ...
    let layout = match &args[1] {
        ...
        _ => {
            return Object::Error {
                message: format!(
                    "time.format: second argument must be STRING layout, got {}",
                    args[1].type_name()
                ),
                line: info.line,
                column: info.column,
...
fn year(args: Vec<Object>, info: CallInfo) -> Object {
    if args.len() != 1 {
        return Object::Error {
            message: "time.year takes 1 argument (unix ms)".to_string(),
            line: info.line,
            column: info.column,
        };
    }
...
fn month(args: Vec<Object>, info: CallInfo) -> Object {
    if args.len() != 1 {
        return Object::Error {
            message: "time.month takes 1 argument (unix ms)".to_string(),
            line: info.line,
            column: info.column,
        };
    }
...
fn day(args: Vec<Object>, info: CallInfo) -> Object {
    if args.len() != 1 {
        return Object::Error {
            message: "time.day takes 1 argument (unix ms)".to_string(),
            line: info.line,
            column: info.column,
        };
    }
...
fn hour(args: Vec<Object>, info: CallInfo) -> Object {
    if args.len() != 1 {
        return Object::Error {
            message: "time.hour takes 1 argument (unix ms)".to_string(),
            line: info.line,
            column: info.column,
        };
    }
...
fn minute(args: Vec<Object>, info: CallInfo) -> Object {
    if args.len() != 1 {
        return Object::Error {
            message: "time.minute takes 1 argument (unix ms)".to_string(),
            line: info.line,
            column: info.column,
        };
    }
...
fn second(args: Vec<Object>, info: CallInfo) -> Object {
    if args.len() != 1 {
        return Object::Error {
            message: "time.second takes 1 argument (unix ms)".to_string(),
            line: info.line,
            column: info.column,
        };
    }
...
pub fn module() -> Object {
    ...
    members.insert(
        "RFC3339".to_string(),
        Object::StringType("%Y-%m-%dT%H:%M:%S%z".to_string()),
    );
    members.insert(
        "Kitchen".to_string(),
        Object::StringType("%I:%M %p".to_string()),
    );
    Object::Module {
        name: "time".to_string(),
        pub_gated: false,
